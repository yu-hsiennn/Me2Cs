...
class MediapipeSmooth2CustomJoints:
    def __init__(self):
        ...
        self.step = 0
        self.finished = False
        self.video_path = "video_data/001.mp4"
        self.save_path = "results/001"
    ...
    def run_detector(self):
        detector = Detector(self.origin_motion, static_image=True)
        detector.detector(self.video_path, self.save_path)
        self.finished = True
